...
export const OrderDetails: React.FC<OrderDetailsProps> = ({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Details`} maxWidth="2xl">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3">
            <div className="flex items-start">
              ...
              <div className="text-sm text-yellow-800">
                ...
                <p>
                  The final amount and provider details are still being
                  calculated by our backend system. This information will be
                  available shortly.
                </p>
              </div>
            </div>
